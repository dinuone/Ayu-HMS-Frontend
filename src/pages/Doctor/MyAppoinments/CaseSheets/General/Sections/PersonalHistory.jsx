    ...
    return (
        <>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 24 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    <label style={{ width: 150 }}>Bath</label>
                    <Input
                        readOnly={readonly}
                        placeholder=""
                        value={data.dietaryHabits.bath}
                        onChange={(e) => onChange('dietaryHabits','bath', e.target.value)}
                    />
                </div>

                <div style={{ display: 'flex', alignItems: 'center' }}>
                    <label style={{ width: 150 }}>Exercise</label>
                    <Input
                        readOnly={readonly}
                        placeholder=""
                        value={data.dietaryHabits.exercise}
                        onChange={(e) => onChange('dietaryHabits','exercise', e.target.value)}
                    />
                </div>
